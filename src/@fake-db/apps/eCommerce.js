  ...
  products: [
    {
      ...
      brand: 'Novana Hotel',
      price: 12,
      image: require('@src/assets/images/pages/rooms/1.jpg').default,
    ...
    },
    {
      ...
      slug: '', 
      description: '',
      brand: 'Ho Tram Resort',
      price: 40,
      image: require('@src/assets/images/pages/rooms/2.jpg').default,
      hasFreeShipping: true,
      hasBreakfast: false,
      rating: 5,
      type: 'Exceptional',
...
// GET: Return Rooms
// ------------------------------------------------
mock.onGet('/apps/ecommerce/rooms').reply(() => {
  return data.rooms
})
